...
BEGIN
  ...
  INSERT INTO public.clients (id, workspace_id, user_id, name, email, color) VALUES
    (cl_mayr,    ws_id, admin_id, 'Kronfeld Metalltechnik GmbH',             'office@kronfeld-metalltechnik.at',  '#ef4444'),
    (cl_steiner, ws_id, admin_id, 'Bergmann & Partner Rechtsanwälte', 'kanzlei@bergmann-rae.at',    '#8b5cf6'),
    (cl_alpen,   ws_id, admin_id, 'Donaukredit AG',                    'info@donaukredit.at',          '#3b82f6'),
    (cl_wohnbau, ws_id, admin_id, 'Stadtquartier Immobilien GmbH',             'buero@stadtquartier-immo.at',    '#f97316'),
    (cl_danubia, ws_id, admin_id, 'Transalpin Logistics KG',            'kontakt@transalpin-log.at',    '#10b981');
  ...
  VALUES
  (ws_id, admin_id, cl_mayr, 'Kronfeld Metalltechnik GmbH', 'INV-202502-001',
  ...
  (ws_id, admin_id, cl_mayr, 'Kronfeld Metalltechnik GmbH', 'INV-202505-001',
  ...
  (ws_id, admin_id, cl_mayr, 'Kronfeld Metalltechnik GmbH', 'INV-202508-001',
    ...
    '2025-08-04', NULL),
  (ws_id, admin_id, cl_mayr, 'Kronfeld Metalltechnik GmbH', 'INV-202511-001',
    ...
    '2025-11-03', NULL),
  (ws_id, admin_id, cl_mayr, 'Kronfeld Metalltechnik GmbH', 'INV-202602-001',
    ...
    '2026-02-02', NULL),
  (ws_id, admin_id, cl_alpen, 'Donaukredit AG', 'INV-202503-001',
  ...
  (ws_id, admin_id, cl_alpen, 'Donaukredit AG', 'INV-202507-001',
  ...
  (ws_id, admin_id, cl_alpen, 'Donaukredit AG', 'INV-202510-001',
    ...
    '2025-10-06', NULL),
  (ws_id, admin_id, cl_alpen, 'Donaukredit AG', 'INV-202601-001',
    ...
    '2026-01-05', NULL),
  (ws_id, admin_id, cl_alpen, 'Donaukredit AG', 'INV-202603-001',
    ...
    '2026-03-02', NULL),
  (ws_id, admin_id, cl_danubia, 'Transalpin Logistics KG', 'INV-202504-001',
  ...
  (ws_id, admin_id, cl_danubia, 'Transalpin Logistics KG', 'INV-202509-001',
  ...
  (ws_id, admin_id, cl_danubia, 'Transalpin Logistics KG', 'INV-202512-001',
    ...
    '2025-12-01', NULL),
  (ws_id, admin_id, cl_steiner, 'Bergmann & Partner Rechtsanwälte', 'INV-202506-001',
  ...
  (ws_id, admin_id, cl_steiner, 'Bergmann & Partner Rechtsanwälte', 'INV-202509-002',
  ...
  (ws_id, admin_id, cl_wohnbau, 'Stadtquartier Immobilien GmbH', 'INV-202507-002',
    ...
    '2025-07-07','2025-08-04'),
  (ws_id, admin_id, cl_wohnbau, 'Stadtquartier Immobilien GmbH', 'INV-202511-002',
